...
<div id="quantity-container-<?= $id ?>" class="table quantity-container">
    <div class="table-cell">
        <div class="table">
            ...
            <div class="relative table-cell vertical-align-top"><input type="text" id="cart-quantity" name="Cart[<?= $id ?>][quantity]" value="<?= $quantity ?>"/><span class="input-label">Qty</span></div>
